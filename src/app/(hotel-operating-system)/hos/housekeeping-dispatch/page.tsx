...
import HousekeepingDispatchModule from "@/modules/hotel-operating-system/housekeeping-dispatch";
...
export default async function Page() {
    ...
    return (
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
                        ...
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="#">HOS</BreadcrumbLink>
                                </BreadcrumbItem>
            ...
            <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-2 sm:p-4 bg-muted/10">
                <HousekeepingDispatchModule />
            </main>
        </div>
    );
}
